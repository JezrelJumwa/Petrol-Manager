...
public final class ExpenseDao_Impl implements ExpenseDao {
  ...
  public ExpenseDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfExpenseEntity = new EntityInsertionAdapter<ExpenseEntity>(__db) {
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(5, entity.getExpenseDate());
        if (entity.getVendor() == null) {
          statement.bindNull(6);
        } else {
          statement.bindString(6, entity.getVendor());
        }
        ...
        if (entity.getMileageAtExpense() == null) {
  ...
  @Override
  public Flow<List<ExpenseEntity>> getExpensesByVehicle(final long vehicleId) {
    final String _sql = "SELECT * FROM expenses WHERE vehicleId = ? ORDER BY expenseDate DESC";
      ...
      public List<ExpenseEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final long _tmpExpenseDate;
            _tmpExpenseDate = _cursor.getLong(_cursorIndexOfExpenseDate);
            ...
            final Integer _tmpMileageAtExpense;
            if (_cursor.isNull(_cursorIndexOfMileageAtExpense)) {
              _tmpMileageAtExpense = null;
            } else {
  ...
  @Override
  public Flow<List<ExpenseEntity>> getExpensesByCategory(final long vehicleId,
      final String category) {
    final String _sql = "SELECT * FROM expenses WHERE vehicleId = ? AND category = ? ORDER BY expenseDate DESC";
  ...
  @Override
  public Flow<List<ExpenseEntity>> getExpensesInDateRange(final long vehicleId,
  ...
  @Override
  public Object getTotalExpenses(final long vehicleId,
      final Continuation<? super Double> $completion) {
    final String _sql = "SELECT SUM(amount) FROM expenses WHERE vehicleId = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, vehicleId);
  ...
  @Override
  public Object getTotalExpensesByCategory(final long vehicleId, final String category,
      final Continuation<? super Double> $completion) {
    final String _sql = "SELECT SUM(amount) FROM expenses WHERE vehicleId = ? AND category = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, vehicleId);
    _argIndex = 2;
  ...
  @Override
  public Object getTotalExpensesInDateRange(final long vehicleId, final long startDate,
  ...
  @Override
  public Flow<List<String>> getExpenseCategories(final long vehicleId) {
    final String _sql = "SELECT DISTINCT category FROM expenses WHERE vehicleId = ? ORDER BY category";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, vehicleId);
