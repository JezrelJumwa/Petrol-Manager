...
public class Industry {
    ...
    @Generated(hash = 700243759)
    public Industry(Long industryId, String name) {
    ...
    public List<Category> getCategories() {
        if (categories == null) {
            ...
            List<Category> categoriesNew = targetDao
                    ._queryIndustry_Categories(industryId);
            synchronized (this) {
                if (categories == null) {
